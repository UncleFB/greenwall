package com.lq.greenwall.config;

import com.lq.greenwall.websocket.WebSocketServer;
...
public class MqttConfig {
    ...
    public MqttPahoClientFactory mqttClientFactory() {
        ...
        options.setServerURIs(new String[]{"tcp://112.126.70.157:1883"});
...
//            }
            try {
                // /ce50e36a8b3f的长度是13
                if(topic.length()>13){
                    WebSocketServer.sendInfo(payload,topic.substring(1,13));
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
